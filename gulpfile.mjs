...
// Production
gulp.task('docs', gulp.series('clean:docs', gulp.parallel('includeFiles:docs', 'sass:docs', 'copyImages:docs', 'fonts:docs', 'files:docs', 'js:docs'), gulp.parallel('server:docs')));
